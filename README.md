...
This is an unmodified version of Douglas Crockford's [Parseq](https://github.com/douglascrockford/parseq) wrapped in a module with curried factory functions. All options are passed to the factory functions in an initial object. 
